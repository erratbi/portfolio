...
const Intro = () => {
  ...
  return (
    <div id="intro" className="cloak h-screen flex items-center">
      <div>
        <h5 className="up-fade cloak font-mono text-primary hidden md:block mb-2 lg:text-lg">Salut, je suis</h5>
        ...
        <p className="up-fade cloak mt-4 leading-relaxed sm:text-lg lg:text-xl lg:max-w-xl">
          Créer des choses pour le <span className="text-primary underline">web</span> et le{' '}
          <span className="text-primary underline">mobile</span>, est ma passion. Je vise toujours à offrir la meilleure
          expérience utilisateur dans tous mes travaux. Actuellement, je travail comme{' '}
